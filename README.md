...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
  ...
  --The useRouteMatch hook attempts to match the current URL in the same way that a route would. It's mostly used for getting access without actually rendering a route



1. How would you explain form validation to someone who has never programmed before?

  --It's a little program that checks if the user put in the right data


1. In 1-2 sentences, define end to end testing.

  --end to end testing simulates what a real user scenario looks like from start to finish or end to end:)
